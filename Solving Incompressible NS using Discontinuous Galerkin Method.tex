...
Note: This is a spectral method. There is only one cell.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Solving Incompressible NS using Discontinuous Galerkin Method_files/Solving Incompressible NS using Discontinuous Galerkin Method_15_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\paragraph{Using Rusanov flux}\label{using-rusanov-flux}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Solving Incompressible NS using Discontinuous Galerkin Method_files/Solving Incompressible NS using Discontinuous Galerkin Method_26_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
advection}\label{using-central-flux-for-advection}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Solving Incompressible NS using Discontinuous Galerkin Method_files/Solving Incompressible NS using Discontinuous Galerkin Method_28_0.png}
    \end{center}
    { \hspace*{\fill} \\}
