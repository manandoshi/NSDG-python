        ...
        for iy in xrange(ny):
            for row_dest in xrange(n):
                for row_source in xrange(n):
                    ...
                    global_M_inv[temp_dest:temp_dest + n, temp_source:temp_source +
                                 n] = M_inv[l_dest:l_dest + n, l_source:l_source + n]

                    global_Dx[temp_dest:temp_dest + n, temp_source:temp_source +
                              n] = Dx[l_dest:l_dest + n, l_source:l_source + n]
                    global_Dy[temp_dest:temp_dest + n, temp_source:temp_source +
                              n] = Dy[l_dest:l_dest + n, l_source:l_source + n]

                    global_Fx[temp_dest:temp_dest + n, temp_source:temp_source +
                              n] = Fx_full[l_dest:l_dest + n, l_source:l_source + n]
                    global_Fy[temp_dest:temp_dest + n, temp_source:temp_source +
                              n] = Fy_full[l_dest:l_dest + n, l_source:l_source + n]
